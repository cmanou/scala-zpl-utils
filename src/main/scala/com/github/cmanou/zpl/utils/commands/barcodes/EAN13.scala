...
case class EAN13(data: String, orientation: Orientation, height: Int, interpretationLine: Boolean, interpretationLineAbove: Boolean) extends PrintableCommand{
  def zpl =
    s"""^BE${orientation.code},$height,${interpretationLine.zpl},${interpretationLineAbove.zpl}
