...
case class Code93(data: String, orientation: Orientation, height: Int, interpretationLine: Boolean, interpretationLineAbove: Boolean, checkDigit: Boolean) extends PrintableCommand{
  def zpl =
    s"""^BA${orientation.code},$height,${interpretationLine.zpl},${interpretationLineAbove.zpl},${checkDigit.zpl}
